      ...
      <div className="w-full max-w-4xl bg-white/90 backdrop-blur-md rounded-2xl shadow-xl p-6">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <p className="mt-4 text-indigo-700 font-medium">Processing Vehicles ...</p>
          </div>
        ) : (
          <>
            <section className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
              ...
              <div className="p-4 rounded-lg bg-white shadow-sm border border-gray-100 hover:shadow-md transition transform hover:-translate-y-1">
                <p className="text-xs text-gray-500 uppercase tracking-wide">Total Fine</p>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="space-y-2 mb-3">
                        ...
                        <p className="text-sm text-gray-600">
                          Fine: <span className="font-medium text-amber-600">Rs {reportItem.fineAmount}</span>
                        </p>
                        <p className="text-sm text-gray-500">Location: {reportItem.location}</p>
                      </div>
